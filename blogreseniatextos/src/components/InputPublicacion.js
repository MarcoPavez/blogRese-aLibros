...
const InputPublicacion = ({
  ...
  return (
    <div>
      <form>
        <h1 class="d-flex justify-content-center">Ingresa tu publicación</h1>
        <h3 class="d-flex justify-content-center">
          ¡Gracias! Nos alegra que eligas usar nuestra plataforma c:
        </h3>
        ...
        <div class="row">
            ...
            <div class="mb-3">
              ...
              <span>
                <em>
                  {" "}
                  <br />
                  Ingresando la URL de la imagen, nos ayudas a reducir el
                  consumo de memoria en nuestros servidores
                </em>
              </span>
              <input
          ...
          <div class="col-8">
            <label>Cuerpo de publicación</label>
            <textarea
