...
const Publicacion = () => {
    ...
    return(
        <div>
        <InputPublicacion postAdd={postAdd} postEditado={postEditado} setPostEditado={setPostEditado} postEdit={postEdit} />
        <TablaPublicaciones publicacion={post} deletePost={postDelete} setPostEditado={setPostEditado} />
        </div>
    )
}
